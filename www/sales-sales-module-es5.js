...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sales-sales-module"], {
  ...
  function srcAppSalesSalesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var moment__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_10__); //import { PeriodicElement } from '../products/products.page';
    ...
    var SalesPage = /*#__PURE__*/function () {
      function SalesPage(saleSrvc, spinnerSrvc, alertSrvc, productSrvc, platform) {
        ...
        'name', 'manufacturer', 'provider', 'cdProductSold', 'vlInput', 'vlOutput', 'amount', 'dtSale', 'lucro', 'delete'];
