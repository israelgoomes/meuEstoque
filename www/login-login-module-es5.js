...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsCadastroCadastroComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsCadastroCadastroComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsCadastroCadastroComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_cadastro_service_cadastro_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../services/cadastro-service/cadastro.service */
    ...
    var CadastroComponent = CadastroComponent_1 = /*#__PURE__*/function () {
      function CadastroComponent(fb, cadastroSrvc, spinnerSrvc, alertSrvc) {
      ...
      _createClass(CadastroComponent, [{
        ...
        value: function cadastrar() {
          ...
          this.cadastroSrvc.cadastrar(this.cadastroForm.value).subscribe(function (response) {
            console.log(response);

            _this3.spinnerSrvc.hide();

            _this3.alertSrvc.toast(response.message, 2000, 'top');

            _this3.result.emit(false);
          }, function (error) {
            _this3.spinnerSrvc.hide();

            console.log('Error', error.error.message);

            _this3.alertSrvc.okAlert("Erro", error.error.validation[0].message);

            _this3.result.emit(true);
          });
        }
      }, {
        key: "cancelar",
        ...
        key: "equalsTo",
        value: function equalsTo(group) {
          var password = group.get('password');
          var senhaConfirmacao = group.get('senhaConfirmacao');
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], CadastroComponent.prototype, "result", void 0);
    CadastroComponent = CadastroComponent_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-cadastro',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./cadastro.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/cadastro/cadastro.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./cadastro.component.scss */
      "./src/app/components/cadastro/cadastro.component.scss"))["default"]]
    })], CadastroComponent);
    /***/
  },
  ...
  function srcAppLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../components/cadastro/cadastro.component */
    "./src/app/components/cadastro/cadastro.component.ts");
  ...
  function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_login_service_login_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(menuCtrl, loginSrvc, route, spinnerSrvc, alertSrvc, fb) {
      ...
      _createClass(LoginPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.menuCtrl.enable(false); // if (localStorage.getItem(configHelper.storageKeys.token)) {
        ...
        value: function login(f) {
          ...
          this.loginSrvc.authenticate(f.value.cnpjCpf, f.value.password).subscribe(function (data) {
            ...
            _this4.loginSrvc.registerLogin(data.token);

            _this4.loginSrvc.registerUser(JSON.stringify(data.usuario));

            _this4.spinnerSrvc.hide();

            _this4.route.navigate(['/products']);

            _this4.alertSrvc.toast('Login efetuado com sucesso!', 2000, 'top');
            ...
            _this4.alertSrvc.okAlert('Erro ao efetuar login', error.error.message);
          });
        }
      }, {
        key: "cadastrar",
  ...
  /***/
  function srcAppServicesCadastroServiceCadastroServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CadastroService = /*#__PURE__*/function () {
      function CadastroService(http) {
        ...
        this.http = http;
        this.url = "".concat(_configurations_configHelper__WEBPACK_IMPORTED_MODULE_2__["configHelper"].URL2, "/company/cadastrar");
      }

      _createClass(CadastroService, [{
        key: "cadastrar",
        value: function cadastrar(data) {
    ...
    CadastroService.ctorParameters = function () {
      return [{
        type: _http_service_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"]
      }];
    };

    CadastroService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], CadastroService);
    /***/
  }
