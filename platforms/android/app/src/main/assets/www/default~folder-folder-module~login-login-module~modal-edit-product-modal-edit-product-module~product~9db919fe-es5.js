...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~folder-folder-module~login-login-module~modal-edit-product-modal-edit-product-module~product~9db919fe"], {
  /***/
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015ButtonJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatButton = /*#__PURE__*/function (_MatButtonMixinBase2) {
      ...
      function MatButton(elementRef, _focusMonitor, _animationMode) {
        ...
        _this27 = _super4.call(this, elementRef);
        ...
        _this27.isRoundButton = _this27._hasHostAttributes('mat-fab', 'mat-mini-fab');
        /**
         * Whether the button is icon button.
         */

        _this27.isIconButton = _this27._hasHostAttributes('mat-icon-button'); // For each of the variant selectors that is present in the button's host
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (_this27._hasHostAttributes(attr)) {
              /** @type {?} */
              _this27._getHostElement().classList.add(attr);
            }
        ...
        _this27._focusMonitor.monitor(_this27._elementRef, true);

        if (_this27.isRoundButton) {
          _this27.color = DEFAULT_ROUND_BUTTON_COLOR;
        }
      ...
      _createClass(MatButton, [{
        ...
        value: function _hasHostAttributes() {
          ...
          */
          function (attribute) {
            return _this28._getHostElement().hasAttribute(attribute);
          });
        }
      }]);
    ...
    function mixinColor(base, defaultColor) {
      return /*#__PURE__*/function (_base2) {
        ...
        function _class2() {
          ...
          _this30 = _super7.call.apply(_super7, [this].concat(args)); // Set the default color that can be specified from the mixin.
    ...
    function mixinErrorState(base) {
      return /*#__PURE__*/function (_base5) {
        ...
        function _class5() {
          ...
          _this33 = _super10.call.apply(_super10, [this].concat(args));
          /**
    ...
    function mixinInitialized(base) {
      return /*#__PURE__*/function (_base6) {
        ...
        function _class6() {
          ...
          _this34 = _super11.call.apply(_super11, [this].concat(args));
          /**
    ...
    */
    ...
    var MatOptgroup = /*#__PURE__*/function (_MatOptgroupMixinBase2) {
      ...
      function MatOptgroup() {
        ...
        _this43 = _super14.apply(this, arguments);
        /**
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015FormFieldJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatFormField = /*#__PURE__*/function (_MatFormFieldMixinBas) {
      ...
      var _super15 = _createSuper(MatFormField);
      ...
      function MatFormField(_elementRef, _changeDetectorRef, labelOptions, _dir, _defaults, _platform, _ngZone, _animationMode) {
        ...
        _this44 = _super15.call(this, _elementRef);
        ...
        _this44._destroyed = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Subject"]();
        /**
        ...
        _this44._hintLabelId = "mat-hint-".concat(nextUniqueId$2++); // Unique id for the internal form field label.

        _this44._labelId = "mat-form-field-label-".concat(nextUniqueId$2++);
        _this44._labelOptions = labelOptions ? labelOptions : {};
      ...
      _createClass(MatFormField, [{
        ...
        value: function ngAfterContentInit() {
          ...
          */
          function () {
            _this45._ngZone.onStable.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(_this45._destroyed)).subscribe(
            /**
            * @return {?}
            */
            function () {
            ...
            */
            function () {
              if (typeof requestAnimationFrame === 'function') {
                _this45._ngZone.runOutsideAngular(
                /**
                * @return {?}
                */
                function () {
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015IconJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatIconRegistry = /*#__PURE__*/function () {
      ...
      _createClass(MatIconRegistry, [{
        ...
        value: function getSvgIconFromUrl(safeUrl) {
          ...
          */
          function (svg) {
            return _this48._cachedIconsByUrl.set(
            /** @type {?} */
            url, svg);
        ...
        value: function _getSvgFromIconSetConfigs(name, iconSetConfigs) {
          ...
          */
          function (iconSetConfig) {
            return _this49._loadSvgIconSetFromConfig(iconSetConfig).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(
            /**
            * @param {?} err
            * @return {?}
            */
            function (err) {
              /** @type {?} */
              var url = _this49._sanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_0__["SecurityContext"].RESOURCE_URL, iconSetConfig.url); // Swallow errors fetching individual URLs so the
              ...
              if (_this49._errorHandler) {
                _this49._errorHandler.handleError(new Error(errorMessage));
              } else {
          ...
          */
          function () {
            /** @type {?} */
            var foundIcon = _this49._extractIconWithNameFromAnySet(name, iconSetConfigs);
        ...
        value: function _loadSvgIconFromConfig(config) {
          ...
          */
          function (svgText) {
            return _this50._createSvgElementForSingleIcon(svgText, config.options);
          }));
        }
        /**
        ...
        value: function _loadSvgIconSetFromConfig(config) {
          ...
          */
          function (svgText) {
            ...
            if (!config.svgElement) {
              config.svgElement = _this51._svgElementFromString(svgText);
            }
        ...
        value: function _fetchUrl(safeUrl) {
          ...
          */
          function () {
            return _this52._inProgressUrlFetches["delete"](url);
    ...
    */
    ...
    var MatIcon = /*#__PURE__*/function (_MatIconMixinBase2) {
      ...
      var _super16 = _createSuper(MatIcon);
      ...
      function MatIcon(elementRef, _iconRegistry, ariaHidden, _location, _errorHandler) {
        ...
        _this53._iconRegistry = _iconRegistry;
        _this53._location = _location;
        _this53._errorHandler = _errorHandler;
        _this53._inline = false;
        /**
         * Subscription to the current in-progress SVG icon request.
         */

        _this53._currentIconFetch = rxjs__WEBPACK_IMPORTED_MODULE_4__["Subscription"].EMPTY; // If the user has not explicitly set aria-hidden, mark the icon as hidden, as this is
        ...
        value: function ngOnChanges(changes) {
          ...
          if (svgIconChanges) {
            ...
            if (this.svgIcon) {
              ...
              */
              function (svg) {
                return _this54._setSvgElement(svg);
              },
              /**
              * @param {?} err
              * @return {?}
              */
              function (err) {
                ...
                if (_this54._errorHandler) {
                  _this54._errorHandler.handleError(new Error(errorMessage));
                } else {
                  console.error(errorMessage);
                }
              });
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015InputJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatInput = /*#__PURE__*/function (_MatInputMixinBase2) {
      ...
      function MatInput(_elementRef, _platform, ngControl, _parentForm, _parentFormGroup, _defaultErrorStateMatcher, inputValueAccessor, _autofillMonitor, ngZone) {
        ...
        _this55 = _super18.call(this, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl);
        ...
        */
        ...
        var element = _this55._elementRef.nativeElement;
        /** @type {?} */
        ...
        _this55._isNativeSelect = nodeName === 'select';
        _this55._isTextarea = nodeName === 'textarea';
...
//# sourceMappingURL=default~folder-folder-module~login-login-module~modal-edit-product-modal-edit-product-module~product~9db919fe-es5.js.map