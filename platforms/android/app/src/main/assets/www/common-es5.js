      ...
      _createClass(ModalEditProductPage, [{
        ...
        value: function save() {
          ...
          this.productSrvc.update(this.productForm.value).subscribe(function () {
            ...
            _this3.alertSrvc.toast("Produto atualizado com sucesso!", 2000, "top");
          }, function (error) {
            _this3.spinnerSrvc.hide();
          });
        }
      ...
      _createClass(ModalSalePage, [{
        ...
        value: function save() {
          ...
          this.saleSrvc.createSale(this.product, this.saleForm.value).subscribe(function () {
            ...
            _this4.alertSrvc.toast("A venda do Produto ".concat(_this4.product.name, " foi realizada com sucesso!\n                               <br> Quantidade: ").concat(_this4.saleForm.get("amount").value), 2000, "top");
  ...
  function srcAppServicesSaleServiceSaleServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SaleService = /*#__PURE__*/function () {
      function SaleService(http) {
        ...
        this.http = http;
        this.url = "".concat(_configurations_configHelper__WEBPACK_IMPORTED_MODULE_1__["configHelper"].URL, "/sale");
      }
      ...
      _createClass(SaleService, [{
        ...
        value: function createSale(dataUpdate, dataCreate) {
          var updateProduct = this.http.put("".concat(_configurations_configHelper__WEBPACK_IMPORTED_MODULE_1__["configHelper"].URL, "/product/").concat(dataUpdate.idProduct), dataUpdate);
